	...
	<div class="container">
		<div class="row col-md-6 col-md-offset-2 custyle">
			<form id="miCarritoForm" name="miCarritoForm" 
				  action="GestionarCarrito" method="POST">
			...
			<table class="table table-striped custab">
				<thead>
					<a href="GestionarCarrito" class="btn btn-primary btn-xs pull-right"><b>+</b>
						Agregar producto</a>
					<tr>
						<th>ID</th>
						<th>Descripcion</th>
					...
					<c:forEach items="${carrito.items}" var="x">
						<tr>
							...
							<td class="text-center">
								<button type="button" 
									data-toggle="modal" data-target="#editarCantidad" data-original-title
									onclick="modificarCantidad(${x.producto.id}, 
										${x.cantidad}, '${x.producto.descripcion}');" 
									class='btn btn-info btn-xs'>
									<span class="glyphicon glyphicon-edit"></span> 
									Modificar cantidad
								</button>
								<button type="button" 
									onclick="eliminarItem(${x.producto.id});" 
